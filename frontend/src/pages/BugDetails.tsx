...
export function BugDetails() {
  ...
  return <AppLayout>
    ...
    {editing && <Modal wide title={`Edit ${bug.bug_key}`} onClose={() => setEditing(false)}><BugForm members={members} initial={initial} limitedFields={user.role === "DEVELOPER"} submitLabel="Save Changes" onSubmit={save} onCancel={() => setEditing(false)} /></Modal>}
  </AppLayout>;
}
